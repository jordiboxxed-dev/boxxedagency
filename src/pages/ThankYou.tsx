  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center text-center overflow-hidden p-4">
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tighter mb-4 [text-shadow:0_0_10px_rgba(0,102,255,0.5)]">
        ...
        <div className="bg-card/50 backdrop-blur-lg border border-neon-purple rounded-lg p-6 md:p-8 text-left transition-all duration-300 shadow-glow-purple">
          <div className="flex items-start gap-4">
            <div className="mt-1">
              <MailCheck className="h-8 w-8 text-neon-purple" />
            </div>
            <div>
